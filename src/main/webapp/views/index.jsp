<!DOCTYPE html>
<%@page import="com.eflyer.model.User"%>
                  ...
                  <div class="container">
                     ...
                     <div class="fashion_section_2">
                        <div class="row">
                           ...
                           <c:if test="${product.productType == 'Fashion'}">
                           		<a href="viewProduct?id=${product.productId}"><div class="box_main">
                                 <h4 class="shirt_text">${product.productName}</h4>
                                 <p class="price_text">Price<span style="color: #262626;">$ ${product.actualPrice}</span></p>
                                 <c:forEach var="image" items="${product.productImages}">
                                 	<c:if test="${image.mainImage}">
                                 		<div class="tshirt_img"><img src="images/${image.imageName}"></div>
                                 	</c:if>
                                 </c:forEach>
